...
if Main_Form.ActiveMDIChild is TPlast_Form then
 begin
  ...
  Plast_M.TPlast_Form(Main_Form.ActiveMDIChild).Plast_ViewConstr_Mnu.Checked := False;
 end;
 end;
...
If main_form.PlastGraphButton.Down = False then main_form.Plast_Graph_Enter_Panel.Visible:=False
...
begin
  ...
  Main_Form.Plast_Sn_Cbx.Items.clear;
      for i:=1 to Plast_M.TPlast_Form(Main_Form.ActiveMDIChild).kl do  Main_Form.Plast_Sn_Cbx.Items.Add('Случай нагружения '+IntToStr(i));
      main_form.Plast_SN_Cbx.ItemIndex:=Plast_M.TPlast_Form(Main_Form.ActiveMDIChild).kl-2;
      inc(Plast_M.TPlast_Form(Main_Form.ActiveMDIChild).plast.kl1);
      main_form.plast_Sn_cbx.Enabled:=true;
//      close;
Main_Form.Plast_Sn_Cbx.Itemindex:=Plast_M.TPlast_Form(Main_Form.ActiveMDIChild).kl-1;
