 ...
 for i:=1 to tok_M.Ttok_Form(Main_Form.ActiveMDIChild).tok.nsm do
  begin
   Nagr_Nagr_ComboBox.Items.Add(IntToStr(i));
    ...
    if tok_M.Ttok_Form(Main_Form.ActiveMDIChild).tok.nsm<=1 then main_form.tok_Sn_cbx.Enabled:=false
     else  main_form.tok_Sn_cbx.Enabled:=true;
 Main_Form.tok_Sn_Cbx.ItemIndex:=tok_M.Ttok_Form(Main_Form.ActiveMDIChild).tok.nsm-1;
  tok_m.ttok_form(main_form.ActiveMDIChild).sn:= main_form.tok_sn_cbx.itemindex+1;
