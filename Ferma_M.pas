...
type
	...
	SolveOpt_Mnu: TMenuItem;
	Results_Mnu: TMenuItem;
	SimpleResults_Mnu: TMenuItem;
	File_Mnu: TMenuItem;
	FileNew_Mnu: TMenuItem;
	FileNewFerm_Mnu: TMenuItem;
	N16: TMenuItem;
	FileOpen_Mnu: TMenuItem;
	FileSave_Mnu: TMenuItem;
	FileSaveAs_Mnu: TMenuItem;
	N20: TMenuItem;
	N21: TMenuItem;
	FileClose_Mnu: TMenuItem;
	Bevel1: TBevel;
	...
	N1: TMenuItem;
	N2: TMenuItem;
	ViewConstr_Mnu: TMenuItem;
	ViewGraph_Mnu: TMenuItem;
	N3: TMenuItem;
	Num_Element: TMenuItem;
	N5: TMenuItem;
	N6: TMenuItem;
	TOK: TMenuItem;
	Razm: TLabel;
    ...
    N17: TMenuItem;
    N14: TMenuItem;
    N15: TMenuItem; //Подменю "Действия" в главном меню.
    N18: TMenuItem; // Кнопка "Назад" в подменю "Действия" в главного меню.
    N19: TMenuItem;
    OK1: TMenuItem;
    ChangeTOK: TMenuItem;
    PopupMenu1: TPopupMenu; // Кнопка "Вперед" в подменю "Действия" в главного меню.
    ...
    procedure WMHotKey(var Mess:TWMHotKey);message WM_HOTKEY;
               ...
               procedure Num_ElementClick(Sender: TObject);
...
//vorozhbit
procedure TFerma_Form.WMHotKey(var Mess: TWMHotKey);
begin
...
begin
     ...
     begin
          Main_Form.{Ferma_Panel.}toolbutton21.Enabled:=false;
          OptResults_Mnu.Enabled                      :=false;
     end;
     {end of my insert}
...
//     List.free;
     ...
     if isParmOpt and Main_Form.F_Save_TBtn.Enabled=True then
      begin
     ...
     if num_ferm=1 then Main_form.Main_Panel.Visible:=true;
...
procedure TFerma_Form.FormDestroy(Sender: TObject);
begin
...
procedure TFerma_Form.FormCreate(Sender: TObject);
  ...
  var i:integer;
    ...
    RegisterHotKey(Handle, id2, MOD_CONTROL, 89);
          ...
          ViewGraph_Mnu.Checked                    := true;
          Main_Form.FermaGraphButton.Down          := true;
...
begin
     ...
     begin
          ...
          MoveTo(coord_axis_X+43,30);LineTo(x_max-29,30); // верх. горизонталь
          MoveTo(x_max-30,y_max-30-coord_axis_Y);LineTo(x_max-30,30); // правая вертикаль
          MoveTo(coord_axis_X+43,y_max-30-coord_axis_Y);LineTo(x_max-15,y_max-30-coord_axis_Y); // Ось X
          LineTo(x_max-20,y_max-35-coord_axis_Y);
          MoveTo(x_max-15,y_max-30-coord_axis_Y);LineTo(x_max-20,y_max-25-coord_axis_Y);
          MoveTo(coord_axis_X+50,y_max-20-coord_axis_Y);LineTo(coord_axis_X+50,15); // Ось Y
          ...
          {if (max_x_coord > 50) then
           begin
            step:=50;
            n_of_step:=round(max_x_coord/50);                    // Ось X
           end
          else}
           begin
            step:=max_x_coord/4;
          ...
          begin
               ...
               TextOut(5,23+step_int*(i-1),number);
          ...
          pen.Width:=3;
          if Ferm.nyz1=0 then
          begin max_x_coord:=1;max_y_coord:=1
          end;
...
begin
     ...
     begin
          ...
          begin
               Main_Form.Ferma_Graph_Enter_ToolBar.Buttons[2].Enabled:=false;
               Main_Form.Ferma_Graph_Enter_ToolBar.Buttons[3].Enabled:=true;
               Main_Form.Ferma_Graph_Enter_ToolBar.Buttons[4].Enabled:=true;
               Main_Form.Ferma_Graph_Enter_ToolBar.Buttons[10].Enabled:=true;
          end
          else begin
               Main_Form.Ferma_Graph_Enter_ToolBar.Buttons[2].Enabled:=true;
               Main_Form.Ferma_Graph_Enter_ToolBar.Buttons[3].Enabled:=true;
               Main_Form.Ferma_Graph_Enter_ToolBar.Buttons[4].Enabled:=true;
               Main_Form.Ferma_Graph_Enter_ToolBar.Buttons[10].Enabled:=true;
          end;
          ...
          Main_Form.Ferma_Graph_Enter_ToolBar.Buttons[2].Enabled:=true;
          Main_Form.Ferma_Graph_Enter_ToolBar.Buttons[3].Enabled:=false;
          Main_Form.Ferma_Graph_Enter_ToolBar.Buttons[4].Enabled:=false;
          Main_Form.Ferma_Graph_Enter_ToolBar.Buttons[10].Enabled:=false;
     end;
     ...
     begin
          if Ferm.nyz1=9 then
          begin
               Main_Form.Ferma_Graph_Enter_ToolBar.Buttons[6].Enabled:=false;
               Main_Form.Ferma_Graph_Enter_ToolBar.Buttons[7].Enabled:=true;
               Main_Form.Ferma_Graph_Enter_ToolBar.Buttons[9].Enabled:=true;
               Main_Form.Ferma_Graph_Enter_ToolBar.Buttons[11].Enabled:=true      
          end
          else begin
               Main_Form.Ferma_Graph_Enter_ToolBar.Buttons[6].Enabled:=true;
               Main_Form.Ferma_Graph_Enter_ToolBar.Buttons[7].Enabled:=true;
               Main_Form.Ferma_Graph_Enter_ToolBar.Buttons[9].Enabled:=true;
               Main_Form.Ferma_Graph_Enter_ToolBar.Buttons[11].Enabled:=true;
          end;
          ...
          Main_Form.Ferma_Graph_Enter_ToolBar.Buttons[6].Enabled:=true;
          Main_Form.Ferma_Graph_Enter_ToolBar.Buttons[7].Enabled:=false;
          Main_Form.Ferma_Graph_Enter_ToolBar.Buttons[9].Enabled:=false;
          Main_Form.Ferma_Graph_Enter_ToolBar.Buttons[11].Enabled:=false;
     end;
...
begin
     ...
     Main_Form.Ferma_Panel.Visible            :=true;
     Main_Form.MainMenu1.Items[1].Enabled     :=true;

     if Main_Form.FermaGraphButton.Down then
     begin
          ViewGraph_Mnu.Checked                    := true;
          Main_Form.Ferma_Graph_Enter_Panel.Visible:=true;
     end
     else ViewGraph_Mnu.Checked := false;
     if Main_Form.FermaKonButton.Down then
     begin
          ViewConstr_Mnu.Checked := true;
          Ferma_Fd_Form.Visible :=true;
     end
     else ViewConstr_Mnu.Checked := false;
     if Main_Form.SimpleResult_TB.ImageIndex=10 then TOK.Checked:=true
     else TOK.Checked:=false;
     if Main_Form.FermaNumberButton.Down=true then Num_Element.Checked:=true
     else Num_Element.Checked:=false;
     ...
     for j:=1 to Main_Form.Ferma_Graph_Enter_ToolBar.ButtonCount-1 do Main_Form.Ferma_Graph_Enter_ToolBar.Buttons[j].Down:=false;
     if not FileExists(ChangeFileExt(FileName,'.vyv')) then
     begin
          Main_Form.SimpleResult_TB.Enabled:=false;
          Main_Form.ToolButton7.Enabled    :=false;
...
begin
     ...
     what_do:=0;
     for i:=0 to Main.Main_Form.Ferma_Graph_Enter_ToolBar.ButtonCount-1 do
     begin
          if Main.Main_Form.Ferma_Graph_Enter_ToolBar.Buttons[i].Down = true then what_do:=Main.Main_Form.Ferma_Graph_Enter_ToolBar.Buttons[i].Tag;
     end;
...
begin
     ...
     if Flag=-1 then Flag:=MessageDlg(chr(13)+'В данной конструкции есть узел/узлы не принадлежащие ни одному стержню! Продолжить?' ,mtWarning,mbOkCancel,0);
     ...
     if w>0 then Flag:=MessageDlg(chr(13)+'Данная конструкция представляет собой механизм! Продолжить?' ,mtWarning,mbOkCancel,0);
     if Flag=mrCancel then exit;
     ...
     if isChanged then
       begin
         Flag:=MessageDlg(chr(13)+'Конструкция была изменена! Перед расчетом изменения будут сохранены. Продолжить?' ,mtWarning,mbOkCancel,0);
         if Flag=mrOk then
...
begin
     ...
     if i in [0..2] then
       ...
       if i=2 then
       begin
         Flag:=MessageDlg(chr(13)+'Расчет закончен. Достигнута заданная точность. Показать результаты?' ,mtInformation,mbOkCancel,0);
         if flag=mrCancel then
           exit;
...
begin
     if ViewConstr_Mnu.Checked = true then
     begin
          Ferma_Fd_Form.Visible        :=false;
          ViewConstr_Mnu.Checked       := false;
          Main_Form.FermaKonButton.Down := false;
     end
     else begin
          Ferma_Fd_Form.Visible        :=true;
          ViewConstr_Mnu.Checked       := true;
          Main_Form.FermaKonButton.Down := true;
     end;
end;
...
begin
 if  tok.Checked then begin
  tok.Checked:=false;
  ChangeTOK.Enabled:=false;
            Main_Form.SimpleResult_TB.ImageIndex:=8;
          Main_Form.TOK_OK_PMI.Checked        :=false;
          Main_Form.TOK_NO_PMI.Checked        :=true;
  end
  ...
  begin
  ChangeTOK.Enabled:=true;
  tok.Checked:=true;
          Main_Form.SimpleResult_TB.ImageIndex:=10;
...
procedure TFerma_Form.Num_ElementClick(Sender: TObject);
var
     i:Integer;
begin

     if Num_Element.Checked=true then
     begin
          Main_Form.FermaNumberButton.Down:=false;
          Num_Element.Checked             :=false;
          for i := Main_Form.MDIChildCount-1 downto 0 do
               Main_Form.MDIChildren[i].Repaint;
     end
     else begin
          Main_Form.FermaNumberButton.Down:=true;
          Num_Element.Checked             :=true;
          for i := Main_Form.MDIChildCount-1 downto 0 do
               Main_Form.MDIChildren[i].Repaint;
     end;
...
begin
     if ViewGraph_Mnu.Checked = true then
     begin
          Main_Form.Ferma_Graph_Enter_Panel.Visible         :=false;
          ViewGraph_Mnu.Checked                             := false;
          Main_Form.FermaGraphButton.Down                   := false;
          Main_Form.Ferma_Graph_Enter_ToolBar.Buttons[0].Down:=true;  
          PaintBox.Cursor                                   :=crDefault;
          PaintBox.ShowHint                                 :=false;
...
main_form.FermaNumberButton.Down:=true; // ВЫвод нумерации - чтоб было удобней
...
//FermOptNode.Ferm_opt_node.ShowModal;// ввод данных с последующей прроверкой необходимых для расчета оптимизации положения узла
  ...
  begin
   ...
   main_form.FermaNumberButton.Down:=false; // ВЫвод нумерации убираем - чтоб было удобней
...
//form3.Grd.Cells[0,2]:='K (Sg / TOK)';
 if  Main_Form.SimpleResult_TB.ImageIndex=10     then // если ток есть
  begin
...
Ferma_M.Tferma_form(Main_Form.ActiveMDIChild).Buf.Add(Ferma_M.Tferma_form(Main_Form.ActiveMDIChild).Ferm);
 ...
 Flag:=MessageDlg(chr(13)+'Оптимизация узлов закончена. Показать результаты?' ,mtInformation,mbOkCancel,0);
 if flag=mrCancel then
   exit;
 if FileExists(ChangeFileExt(FileName,'.vyv')) then
   begin
...
//  ferma5_kol_uzlov:=strtoint(Fermoptmassa.Ferm_opt_massa.Edit9.Text); // считаем сколько узлов вел пользователь
  ...
  begin
   ...
   main_form.FermaNumberButton.Down:=false; // ВЫвод нумерации - чтоб было удобней
   Ferma_M.TFerma_Form(Main_Form.ActiveMDIChild).RePaint;
   goto nn;
  end
  else
...
Flag:=MessageDlg(chr(13)+'Совместная оптимизация закончена. Показать результаты?' ,mtInformation,mbOkCancel,0);
 if flag=mrCancel then
   exit;
 if FileExists(ChangeFileExt(FileName,'.vyf')) then
 begin
...
procedure TFerma_Form.N15Click(Sender: TObject);
begin
