...
{ Nagr_Nagr_ComboBox.Items.Clear;
   ...
   Nagr_Nagr_ComboBox.ItemIndex:=Main_Form.Plast_Sn_Cbx.ItemIndex;}
      ...
      Nagr_Nagr_Label.caption:=inttostr(Main_Form.Plast_Sn_Cbx.ItemIndex+1);
...
var
 {node,}sn:integer;
begin
 Main_Form.Plast_Sn_CBx.ItemIndex:=Nagr_Nagr_ComboBox.ItemIndex;
...
{ Plast_M.TPlast_Form(Main_Form.ActiveMDIChild).Tag:=Plast_M.TPlast_Form(Main_Form.ActiveMDIChild).Plast.kz1;}
 ...
 Main_Form.plast_Sn_Cbx.ItemIndex:=Plast_M.TPlast_Form(Main_Form.ActiveMDIChild).Plast.kl1-1;
...
//for i:=i to 3 do kt[i]:=Plast_M.TPlast_Form(Main_Form.ActiveMDIChild).kt[i];
      ...
      error:=False;
      try
        val(ForceY_Edt.Text,form.nagruz[main_form.Plast_SN_Cbx.ItemIndex+1,form.kt[main_form.Plast_SN_Cbx.ItemIndex+1],4],code);
      except
        Beep;
        Main_Form.StatusBar1.Panels[1].Text :='Ошибка при вводе силы по Y';
        Main_Form.StatusBar1.Panels[2].Text :='Было введено не число';
      ...
      try
        val(ForceX_Edt.Text,form.nagruz[main_form.Plast_SN_Cbx.ItemIndex+1,form.kt[main_form.Plast_SN_Cbx.ItemIndex+1],3],code);
      except
        Beep;
        Main_Form.StatusBar1.Panels[1].Text :='Ошибка при вводе силы по X';
        Main_Form.StatusBar1.Panels[2].Text :='Было введено не число';
  ...
  if not error then
   begin
    form.nagruz[main_form.Plast_SN_Cbx.ItemIndex+1,form.kt[main_form.Plast_SN_Cbx.ItemIndex+1],2]:=33;
    if form.nagruz[main_form.Plast_SN_Cbx.ItemIndex+1,form.kt[main_form.Plast_SN_Cbx.ItemIndex+1],3]=0 then form.nagruz[main_form.Plast_SN_Cbx.ItemIndex+1,form.kt[main_form.Plast_SN_Cbx.ItemIndex+1],2]:=22;
    if form.nagruz[main_form.Plast_SN_Cbx.ItemIndex+1,form.kt[main_form.Plast_SN_Cbx.ItemIndex+1],4]=0 then form.nagruz[main_form.Plast_SN_Cbx.ItemIndex+1,form.kt[main_form.Plast_SN_Cbx.ItemIndex+1],2]:=11;
   form.initialize;
   Plast_M.TPlast_Form(Main_Form.ActiveMDIChild).isChanged:=true;
   Main_Form.P_Save_TBtn.Enabled:=true;
